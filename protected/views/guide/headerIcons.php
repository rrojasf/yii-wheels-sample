        ...
        <div class="btn-group">
            ...
            <div class="dropdown-menu quick-info">
                <table class="info-dropdown">
                    <tbody><tr><td class="aqua-avatar-quick-list" rowspan="4"> <img height="45" alt="user" src="<?php echo Yii::app()->theme->baseUrl; ?>/images/avatar1.jpg" class="img-rounded img-polaroid"></td></tr>
                ...
                <table class="info-dropdown">
                    <tbody><tr><td class="aqua-avatar-quick-list" rowspan="4">  <img height="45" alt="user" src="<?php echo Yii::app()->theme->baseUrl; ?>/images/avatar2.jpg" class="img-rounded img-polaroid"></td></tr>
                        <tr><td><a href="#">John Doe <span class="modernpics icons16">=</span></a></td></tr>
                        <tr><td>2/9/2012 10:15 <span class="modernpics icons16">}</span></td></tr>
                        <tr><td>john.doe@mail.com <span class="modernpics icons16">@</span></td></tr>
                    </tbody></table>
                <table class="info-dropdown">
                    <tbody><tr><td class="aqua-avatar-quick-list" rowspan="4">  <img height="45" alt="user" src="<?php echo Yii::app()->theme->baseUrl; ?>/images/avatar3.jpg" class="img-rounded img-polaroid"></td></tr>
                        <tr><td><a href="#">John Doe <span class="modernpics icons16">=</span></a></td></tr>
                        <tr><td>2/9/2012 10:15 <span class="modernpics icons16">}</span></td></tr>
                        <tr><td>john.doe@mail.com <span class="modernpics icons16">@</span></td></tr>
                    </tbody></table>
                <table class="info-dropdown">
                    <tbody><tr><td class="aqua-avatar-quick-list" rowspan="4">  <img height="45" alt="user" src="<?php echo Yii::app()->theme->baseUrl; ?>/images/avatar4.jpg" class="img-rounded img-polaroid"></td></tr>
                        <tr><td><a href="#">John Doe <span class="modernpics icons16">=</span></a></td></tr>
                        <tr><td>2/9/2012 10:15 <span class="modernpics icons16">}</span></td></tr>
                        <tr><td>john.doe@mail.com <span class="modernpics icons16">@</span></td></tr>
                    </tbody></table>
