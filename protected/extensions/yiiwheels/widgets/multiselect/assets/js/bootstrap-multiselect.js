...
!function($) {
    ...
    Multiselect.prototype = {
        ...
        createOptionValue: function(element) {
            ...
            $checkbox.val(value);
            /**
             * Added by Robert Rojas Fernández - 06/02/2014 - robert.rojas@veanos.com
             * plugin has conflict with multiple selects on same form when more than one may be 
             * multiselect checkbox with posible same values and one has a checkbox max num...
             */ 
            $checkbox.attr('id', this.$select.attr('id') + '_' + $checkbox.val());
